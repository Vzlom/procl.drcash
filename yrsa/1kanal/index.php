...
<!-- DrCash -->
<script type="text/javascript">window.onload = function() { relink('<?php echo ot_add_params("out.php");?>','b.tracking.drcash.me'); metrica(location.search.replace("?","&") + '&host=' + location.host + location.pathname); } </script>
